...
Fixpoint path_seq {A lvl K C} (p : path A lvl K C) {struct p} : list A :=
  ...
  let buffer_seq {B lvl q} (b : buffer.t (stored_triple B lvl) q) : list B :=
    map_buffer (@stored_triple_seq B) b in
  let fix triple_left_seq {B lvl len K1 K2 C} (t : triple B lvl len K1 K2 C) {struct t} : list B :=
  ...
  let fix triple_right_seq {B lvl len K1 K2 C} (t : triple B lvl len K1 K2 C) {struct t} : list B :=
...
Fixpoint triple_left_seq {A lvl len K1 K2 C} (t : triple A lvl len K1 K2 C) : list A :=
...
Fixpoint triple_right_seq {A lvl len K1 K2 C} (t : triple A lvl len K1 K2 C) : list A :=
